...
var hideAlert = function hideAlert() {
  var el = (0, _jquery.default)('.alert');
...
var showAlert = function showAlert(type, msg) {
  ...
  (0, _jquery.default)('body').append(markup);
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 4:
            ...
            if (res.status === 200) {
              (0, _alert.showAlert)('success', 'Succesfully Logged in!');
              window.setTimeout(function () {
                location.assign('/');
              }, 2000);
            }
...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiYXJ0b2Z1IiwiYSI6ImNrYzZxdXI0eTBwc3UzM3Q2YXA4NzhkcnkifQ.80OZIk2Nh3aCUgJMo07FJw';
  var array = locations[0].coordinates;
  var map = new mapboxgl.Map({
    container: 'map',
    style: 'mapbox://styles/artofu/ckc6ra7421jsg1inv2na6esr7',
    scrollZoom: false // center: array,
    //zoom: 1,
    // interactive: false
  ...
  locations.forEach(function (el) {
    ...
    }).setLngLat(el.coordinates).setPopup(new mapboxgl.Popup({
      offset: 30,
      className: 'map-popup',
      closeOnClick: false
    }).setHTML("<p>".concat(el.description, "</p>"))).addTo(map);
...
var stripe = Stripe('pk_test_51H4rumHjcSXMUMWn543wHybUXGgQpQTXeTJPaIK8iou1gIj4az47UskfxdQNvHd4iQFXAE2Wku7V9rO77d0SwaNK003Rg7rhAO');
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.status === 201) {
              (0, _alert.showAlert)('success', 'Your Account Was Created!');
              window.setTimeout(function () {
                location.assign('/');
              }, 1000);
            }
...
},{"axios":"../../node_modules/axios/index.js","./alert.js":"alert.js"}],"submit.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.deleteBooking = exports.deleteReview = exports.update = exports.submit = void 0;
...
function returnId(id) {
  var r;
  Object.keys(id).forEach(function (el) {
    r = id[el];
  });
  return r;
}
...
var submit = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(data, slug) {
    var res;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.status === 201) {
              (0, _alert.showAlert)('success', 'Succesfully Published!');
              window.setTimeout(function () {
...
var update = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(id, data, slug) {
    var r, url, res;
    return regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            _context2.prev = 0;
            r = returnId(id);
            url = "http://127.0.0.1:3000/api/v1/reviews/".concat(r);
            _context2.next = 5;
            return (0, _axios.default)({
              method: 'PATCH',
              url: url,
          ...
          case 5:
            ...
            if (res.status === 200) {
              (0, _alert.showAlert)('success', 'Succesfully Edited!');
              window.setTimeout(function () {
                location.assign("/tour/".concat(slug));
              }, 2000);
            }
...
var deleteReview = /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3(id, slug) {
    var r, url, res;
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          ...
          case 5:
            ...
            if (res.status === 204) {
              (0, _alert.showAlert)('success', 'Succesfully Deleted!');
              window.setTimeout(function () {
                location.assign("/tour/".concat(slug));
              }, 2000);
            }
  ...
  return function deleteReview(_x6, _x7) {
...
var deleteBooking = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context4.prev = _context4.next) {
          ...
          case 4:
            ...
            if (res.status === 204) {
              (0, _alert.showAlert)('success', 'You canceled the booking! You money will be refund soon! ');
              window.setTimeout(function () {
                location.assign("/");
              }, 3000);
            }
  ...
  return function deleteBooking(_x8) {
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 4:
            ...
            if (res.status === 200) {
              (0, _alert.showAlert)('success', "".concat(type, " Succesfully Updated!")); //WE NEED TO SPECIFY TRUE, AND THEN WILL FORCE TO RELOAD FROM THE SERVER AND NOT FROM BROWSER CACHE
...
function loop() {
  ...
  for (var i = 1; i < 6; i++) {
    var color = (0, _jquery.default)("#star-".concat(i)).is(':checked');
...
var reviewArea = (0, _jquery.default)('.review-area');
var formSign = (0, _jquery.default)('.form--signup');
var mapBox = (0, _jquery.default)('#map');
var form = (0, _jquery.default)('.form--login');
var formUserData = (0, _jquery.default)('.form-user-data');
var logoutEle = (0, _jquery.default)('.nav__el--logout');
var submitButton = (0, _jquery.default)('#myButton');
var formPassword = (0, _jquery.default)('.form-user-settings');
var buttonSave = (0, _jquery.default)('#myButtontwo');
var cancelBooking = (0, _jquery.default)('.cancelBooking');
var greenButton = (0, _jquery.default)('#book-tour');
var errorButton = (0, _jquery.default)('#errorButton2');
var slug = window.location.href.split('/')[window.location.href.split('/').length - 1]; //DELEGATION

if (cancelBooking.length) {
  cancelBooking.on('click', function (e) {
    var bookingId = JSON.parse(e.target.dataset.user);
    (0, _submit.deleteBooking)(bookingId._id);
  });
}

if (buttonSave.length) {
  var review = (0, _jquery.default)('#review-input');
  var rat = reviewArea.data()[Object.keys(reviewArea.data())[0]];
  (0, _jquery.default)("#star-".concat(rat)).prop("checked", true);
  buttonSave.on('click', function (e) {
    var reviewText = review.val();
    var num = loop();
    var ide = errorButton.data();
    var obj = {
      rating: num,
      review: reviewText
    };
    (0, _submit.update)(ide, obj, slug);
  });
}

if (errorButton.length) {
  errorButton.on('click', function (e) {
    (0, _submit.deleteReview)(e.target.dataset, slug);
  });
}
...
if (submitButton.length) {
  submitButton.on('click', function (e) {
    // 1) Get the review
    var review = (0, _jquery.default)('#review-input').val(); // 2) Get the ratingA

    var num = loop(); // 3) Get the author

    var userId = e.target.dataset.userId; // 4) Get the current tour

    var _$$data = (0, _jquery.default)('#review-input').data(),
        tourId = _$$data.tourId;
...
if (formSign.length) {
  formSign.on('submit', /*#__PURE__*/function () {
          ...
          switch (_context.prev = _context.next) {
            case 0:
              ...
              obj = {
                ...
                passwordConfirm: (0, _jquery.default)('#password-confirm').val()
              };
              (0, _jquery.default)('.btn-sign').text('Signing Up...');
              _context.next = 5;
              return (0, _signup.signup)(obj);

            case 5:
              (0, _jquery.default)('.btn-sign').text('Sign Up');
...
if (formPassword.length) {
  formPassword.on('submit', /*#__PURE__*/function () {
    var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(e) {
      ...
      return regeneratorRuntime.wrap(function _callee2$(_context2) {
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              (0, _jquery.default)('.btn--save-password').text('Updating...');
              e.preventDefault();
              currentPassword = (0, _jquery.default)('#password-current').val();
              newPassword = (0, _jquery.default)('#password').val();
              confirmPassword = (0, _jquery.default)('#password-confirm').val();
              _context2.next = 7;
            ...
            case 7:
              (0, _jquery.default)('.btn--save-password').text('Save Passsword');
              (0, _jquery.default)('#password-confirm').val('');
              (0, _jquery.default)('#password-current').val('');
              (0, _jquery.default)('#password').val('');
...
if (formUserData.length) {
  formUserData.on('submit', function (e) {
    ...
    form.append('name', (0, _jquery.default)('#name').val());
    form.append('email', (0, _jquery.default)('#email').val());
    form.append('photo', (0, _jquery.default)('#photo')[0].files[0]);
    (0, _updateSettings.updateSettings)(form, 'Data');
  });
}

if (mapBox.length) {
  var locations = JSON.parse(mapBox.attr('data-locations'));
